...
exports.getTime = (format, date) => {
    if (date) {
        ...
        return moment(date).locale('en-in').format(format)
    } else {
        return moment.tz('Asia/Kolkata').locale('en-in').format(format)
    }
}

exports.formatDate = (n, locale = 'en-IN') => {

        return moment(date).tz(INDIA_TIME_ZONE).locale(INDIA_LOCALE).format(format)
    } else {
        return moment.tz(INDIA_TIME_ZONE).locale(INDIA_LOCALE).format(format)
    }
}

exports.formatDate = (n, locale = INDIA_LOCALE) => {
...
exports.tanggal = (numer) => {
    ...
    return formatter.format(new Date(numer));
...
exports.jam = (numer, options = {}) => {
    ...
    let jam = options?.timeZone ? moment(numer).tz(options.timeZone).format(format) : moment(numer).tz(INDIA_TIME_ZONE).format(format)


    return `${jam}`
}

exports.formatIndianDateTime = (date = new Date(), options = {}) => {
